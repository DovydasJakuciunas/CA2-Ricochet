...
std::vector<AircraftData> InitializeAircraftData()
{
	...
	data[static_cast<int>(AircraftType::kEagle)].m_speed = 225.f;
	data[static_cast<int>(AircraftType::kEagle)].m_fire_interval = sf::seconds(3);
...
std::vector<ParticleData> InitializeParticleData()
{
	...
	data[static_cast<int>(ParticleType::kPropellant)].m_lifetime = sf::seconds(.25f);

	data[static_cast<int>(ParticleType::kSmoke)].m_color = sf::Color(50, 50, 50);
	data[static_cast<int>(ParticleType::kSmoke)].m_lifetime = sf::seconds(1.f);
	return data;
}
